...
String _$portfolioDataSourceHash() =>
    r'8dea98498af30e7709ddd0e3aab33adce21ea7ad';

/// See also [portfolioDataSource].
@ProviderFor(portfolioDataSource)
final portfolioDataSourceProvider =
    AutoDisposeProvider<PortfolioDataSource>.internal(
      portfolioDataSource,
      name: r'portfolioDataSourceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$portfolioDataSourceHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef PortfolioDataSourceRef = AutoDisposeProviderRef<PortfolioDataSource>;
String _$portfolioRepositoryHash() =>
    r'8a26eda50e36f9bd5532ab1b3a94f73e7d9c63e9';
...
String _$getAssetsUseCaseHash() => r'db286ec449afd815e2bbd246b4823f82d55b4c9c';

/// See also [getAssetsUseCase].
@ProviderFor(getAssetsUseCase)
final getAssetsUseCaseProvider = AutoDisposeProvider<GetAssetsUseCase>.internal(
  getAssetsUseCase,
  name: r'getAssetsUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getAssetsUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef GetAssetsUseCaseRef = AutoDisposeProviderRef<GetAssetsUseCase>;
